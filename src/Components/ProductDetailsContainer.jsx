...
const ProductDetailsContainer = ({ productDetails }) => {
  ...
  return (
    <div className=" flex flex-col gap-2">
      ...
      {(category == "womens-dresses" || category == "mens-shirts" || category == "tops") && <div className="flex gap-4 items-center">
      ...
      {(category == "womens-dresses" || category == "mens-shirts" || category == "tops") && <div className="flex gap-3 md:gap-4 items-center">
      ...
      <div className="flex gap-4 items-center justify-start mt-2">
        ...
        <div className="flex items-center  border-2 border-gray-400 text-base font-title p-2 rounded-md font-medium">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div>
              <span className="text-xs font-title font-medium pr-2">
                {returnPolicy}. 
                <span className="underline mx-1">Details</span>
              </span>
            </div>
          </div>
        </div>
